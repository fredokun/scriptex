...
\item a html/css/javascript format for interactive web pages {% blablablabla %}
\end{itemize}
...
\section{ {{$var2}} Conclusion}

You should **definitely** try to use \emph{Tango {{$var1}}} when it's ready.
