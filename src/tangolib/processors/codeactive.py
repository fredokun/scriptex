...
class ExecPythonProcessor(CommandProcessor):
    ...
    def process_command(self, processor, cmd):
        self.python_context.exec_python(cmd.content, processor.document.filename, cmd.header_end_pos.lpos)
...
def register_processors(processor, python_context):
    ...
    processor.register_command_processor("execPython", ExecPythonProcessor(python_context))
