...
_Tango_ is a document processing system similar to Sphinx or Pandoc with
...
For very pragmatic reasons _Tango_ is written in \url[Python]{http://www.python.org}.

\section{Conclusion}

You should __definitely__ try to use \emph{Tango} when it's ready.
